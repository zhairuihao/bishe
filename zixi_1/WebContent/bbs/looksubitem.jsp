...
document.getElementById("frame1").src="selectSubitem.action?titemId="+itemId;
}
</script>
...
<div class="nav-down">
    ...
    <div class="rightcon">
    	<div class="right_con">
        	<p style="text-align:left; margin-top:50px" id="p1">欢迎进入后台管理>> 浏览子栏目>></p>
             <p align="right" id="p2">
                选择栏目：
            <select name="titemId" id="itemId" onchange="changeSource()">
           <c:forEach items="${sessionScope.allitems }" var="item" varStatus="itemss">
			<option value="${item.itemId }">${item.itemName }</option>
			</c:forEach>
            </select>
            </p>
            
                <iframe id="frame1" src="selectSubitem.action?titemId=1" height="430px" width="100%"
