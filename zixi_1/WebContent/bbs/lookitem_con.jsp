...
<div id="container">   
	...
	<caption>浏览栏目</caption>
        ...
        <tbody>
				<c:forEach items="${sessionScope.allitems}"  var="items" varStatus="uuser">
				
				<tr>
				<td>${items.itemId}</td>
				<td>${items.itemName}</td>							
				<td>${items.itemDescript}</td>
				<td>${items.manager.username}</td>
				<td><a href="deleteitem.action?itemId=${items.itemId}&d_delete=${items.d_delete}">
