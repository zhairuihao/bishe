...
document.getElementById("frame1").src="selectuser.action?popedom="+popedom;
}
</script>
...
<div class="nav-down">
    ...
    <div class="rightcon">
    	<div class="right_con">
        	<p style="text-align:left; margin-top:50px" id="p1">欢迎进入后台管理>>用户查看>></p>
            <p align="right" id="p2">
                选择权限：
            <select name="popedom" id="popedom" onchange="changeSource()">
            ...
            <option value="4">管理员</option>
                ...
                <iframe id="frame1" src="selectuser.action?popedom=1" height="430px" width="100%"
